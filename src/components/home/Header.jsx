...
const Header = () => {
  return (
    <section className="bg-cloud-white relative overflow-hidden px-4  ">
      ...
      <div className="max-w-300 mx-auto lg:pt-11.75 md:pt-8 sm:mt-6 mt-5 xl:min-h-225 lg:min-h-200 md:min-h-160 min-h-120  bg-[url('/herbg.png')] lg:bg-size-[400px_750px] md:bg-size-[auto_500px] sm:bg-size-[auto_400px] bg-size-[300px_300px] bg-no-repeat bg-bottom">
